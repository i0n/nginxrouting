...
EOS
	opt :file, "Spreadsheet (xls) to take the URLs from", :short => "f", :default => 'bizlink_ip_mappings.xls'
...
# the following code runs against Ben's spreadsheet.
# find and download it and change the name of openned spreadsheet to use.
